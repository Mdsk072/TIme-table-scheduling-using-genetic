...
class Data:
    ...
    MEETING_TIMES=[["MT1","MWF 09:00 - 10:00"],
                   ...
                   ["MT3","TTH 09:00 - 10:30"],
                   ["MT4","TTH 10:30 - 12:00"]]
    INSTRUCTORS=[["T1","Dr Sandeep Mishra"],
                ["T2","Dr Sanjeev Sharma "],
                ["T3","Dr Bhupendra Singh "],
                ["T4","Dr Tanmoy Hazra"]]
    def __init__(self):
        ...
        dept1=Department("CSE",[course1,course3,course6])
        dept2=Department("ECE",[course2,course4,course5,course7])
...
while(population.get_schedules()[0].get_fitness()!=1.0):
    ...
    if population.get_schedules()[0].get_fitness()==1.0:
        ...
        displayMgr.print_schedule_as_table(population.get_schedules()[0])
print("\n\n")
print("the total exection time =",time.time()-start)
